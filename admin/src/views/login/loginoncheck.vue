...
export default {
  ...
  created () {
    ...
    this.loginForm.password = utils.getCrypto(this.$route.query.password)
    // console.log(utils.getCrypto(this.$route.query.password))
    // console.log(utils.getCrypto(this.$route.query.type))
