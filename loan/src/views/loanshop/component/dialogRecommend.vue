    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="small">
      ...
      <el-form-item
            label="排序"
              ...
              >
              <el-input-number v-model="form.productSort" style="width:100px;" :min="0" :max="1000" controls-position="right"></el-input-number>
            </el-form-item>
      <el-row>
        <el-col :span="12">
          <el-form-item label="可借额度：" prop="borrowType">
            ...
            <div>
              ...
              <el-form-item
                style="display:inline-block; width:155px;" prop="maxBorrowLimit">
        ...
        <el-col :span="12">
          <el-form-item label="借款期限：" prop="loanType">
            ...
            <div>
              ...
              <el-form-item
                style="display:inline-block; width:155px;" prop="maxLoanPeriod">
      ...
      <el-form-item label="费用说明：" prop="costDescription">
        <el-input type="textarea" v-model="form.costDescription" placeholder="请输入费用说明" style="width:80%"></el-input>
      </el-form-item>
        </el-col>
        <el-col :span="12">
      <el-form-item label="还款说明：" prop="repayDescription">
        <el-input type="textarea" v-model="form.repayDescription" placeholder="请输入还款说明" style="width:80%"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        repayDescription: [
          { required: true, message: '请输入还款说明', trigger: 'blur' }
        ],
        productLabelList: [
          { required: true, message: '请选择标签ID', trigger: 'blur' }
        ],
        remark: [
  ...
  methods: {
    ...
    handleEdit () {
      ...
      this.form.productSort = this.row.productSort
      this.form.productChannelList = requestChannelObj
      this.form.productLabelList = requestLabelObj
      this.form.costDescription = this.row.costDescription
      this.form.repayDescription = this.row.repayDescription
    },
    // 处理保存信息
    onSave () {
      this.$refs['form'].validate((valid) => {
        ...
        if (valid) {
          ...
          let reqCommond = productId ? 'RECOMMEND_MOD' : 'RECOMMEND_ADD'
