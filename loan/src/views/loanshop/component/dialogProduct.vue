<template>
  <el-dialog
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="small">
          ...
          <el-form-item label="可借额度：" prop="borrowType">
            ...
            <div>
              <el-form-item
                ...
                <el-input v-model="form.minBorrowLimit" maxlength="10" placeholder="请输入最低可借额度" ></el-input>
              </el-form-item>
              <el-form-item
                style="display:inline-block; width:125px;" prop="maxBorrowLimit">
                <el-input v-model="form.maxBorrowLimit" maxlength="10" placeholder="请输入最高可借额度" ></el-input>
              </el-form-item>
            </div>
          </el-form-item>
        </el-col>
      ...
      <el-form-item label="分发链接：" prop="distributeLink">
        <el-input v-model="form.distributeLink" placeholder="请输入分发链接,无可不填" style="width:80%"></el-input>
      </el-form-item>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        distributeLink: [
          { required: false, message: '请输入分发链接', trigger: 'blur' },
          { type: 'url', message: '请输入正确分发链接', trigger: 'blur' }
        ],
        productLabelList: [
  ...
  methods: {
    ...
    handleEdit () {
      ...
      this.form.distributeLink = this.row.distributeLink
