<template>
  <div class="box">
    ...
    <!-- uv量转换统计 -->
    <div class="countone">
      <div class="tip"><p style="font-weight:bold;">UV量转换统计</p></div>
      <div class="tab">
    ...
    <!-- 甲方注册量统计 -->
    <div class="counttwo">
      <div class="tip"><p style="font-weight:bold;">甲方UV量统计</p></div>
      <div class="tab">
    ...
    <div class="activeCount">
      <div class="tip"><p style="font-weight:bold;">贷超总活跃</p></div>
    </div>
    <!-- 贷超总活跃 -->
    <div class="activeAll">
      <el-table
